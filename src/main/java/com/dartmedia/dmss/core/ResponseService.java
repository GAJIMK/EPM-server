package com.dartmedia.dmss.core;
...
public class ResponseService {
  ...
  public enum CommonResponse {
    SUCCESS(0, "처리 성공"), AUTHSUCCESS(10, "인증서 유효"), AUTH_MESSAGE_SUCCESS(11, "문자인증 성공"), EXIST(20, "데이터가 이미 있습니다."),
    LINK_EMAIL_EXIST(21, "이미 등록된 정보가 있습니다.!"), FAIL(-10, "처리가 실패 했습니다."), ERR(-20, "처리가 실패했습니다."),
    ERR_PARAM(-21, "파라미터가 잘못됨"), ERR_PHONE_NUMBER(-22, "전화번호가 잘못됨"), AUTH_MESSAGE_FAIL(-23, "문자인증 실패"),
    MESSAGE_TIMEOUT(-24, "문자인증 시간초과"), FAIL_PARAM_VALID(-25, "파라미터 잘못됨 "), LOGINFAIL(-30, "로그인 실패 했습니다."),
    UNABLE_SCHEDULE(-40, "이미 등록된 일정입니다."), UNABLE_ADMIN_SCHEDULE(-41, "이미 등록된 (관리자)일정입니다."),
    UNABLE_FIX_SCHEDULE(-42, "예약된 일정이 있습니다."), UNABLE_PROPOSAL_SCHEDULE(-43, "제안된 일정이 있습니다."),
  ...
  public <T> CommonResult getSingleResult(T data) {
    SingleResult<T> result = new SingleResult<>();
    result.setData(data);
