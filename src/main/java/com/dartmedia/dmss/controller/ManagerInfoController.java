...
public class ManagerInfoController {
  ...
  public ResponseEntity<?> findManager(
      @ApiParam(value = "마스터여부", required = true) @PathVariable("master") String master) {
  ...
  public ResponseEntity<?> findManagerByFuncId(@ApiParam(value = "마스터여부", required = true) @PathVariable String master,
    ...
    try {
      ...
      if (findManager.getAccountNm() != null)
        result = (SingleResult<ManagerInfo>) responseService.getSingleResult(findManager);
      else
